...
#### Q.2 Reinforcement learning is similar to...:
...
#### Q.3 What are the inputs of biological neurons?:
...
#### Q.4 What was the name of the AI able to beat the best GO player in 2015?:
...
#### Q.5 What was the name of the AI able to beat Kasparov in 1997?:
...
#### Q.6 In reinforcement learning the environment takes as input the action performed by the agent and returns:
...
#### Q.7 Why did Microsoft's AI chatbot become racist?:
...
#### Q.8 A Multilayer Perceptron can solve:
...
#### Q.9 Deep learning is good working with...:
...
#### Q.11 What is the Validation set in Machine learning?:
...
#### Q.12 What are the 'outputs' of biological neurons?:
...
#### Q.14 What is the Training set in Machine Learning?:
...
#### Q.15 Why is Imagenet so hard to learn for a model?:
...
#### Q.16 Why is it required to minimize an error to train a deep learning model?:
...
#### Q.18 What is the Bias Problem in Machine Learning?:
...
#### Q.19 In order to train a model with supervised learning to predict something you first need to:
...
#### Q.20 When was the last major breakthrough in Deep Learning and why?:
...
#### Q.22 Select the correct proposal:
...
#### Q.24 In what does AlphaGoZero differ from AlphaGo?:
...
#### Q.26 What is Artificial General Intelligence?:
...
#### Q.27 What is the name of a famous algorithm to minimize a function/error in a neural network?:
...
#### Q.30 What is Artificial Super Intelligence?:
