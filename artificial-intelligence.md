...
#### Q. Reinforcement learning is similar to...
...
#### Q. What are the inputs of biological neurons?
...
#### Q. What was the name of the AI able to beat the best GO player in 2015?
...
#### Q. What was the name of the AI able to beat Kasparov in 1997?
...
#### Q. In reinforcement learning the environment takes as input the action performed by the agent and returns:
...
#### Q. Why did Microsoft's AI chatbot become racist?
...
#### Q. A Multilayer Perceptron can solve:
...
#### Q. Deep learning is good working with...
...
#### Q. What is the Validation set in Machine learning?
...
#### Q. What are the 'outputs' of biological neurons?
...
#### Q. What is the Training set in Machine Learning?
...
#### Q. Why is Imagenet so hard to learn for a model?
...
#### Q. Why is it required to minimize an error to train a deep learning model?
...
#### Q. What is the Bias Problem in Machine Learning?
...
#### Q. In order to train a model with supervised learning to predict something you first need to:
...
#### Q. When was the last major breakthrough in Deep Learning and why?
...
#### Q. In what does AlphaGoZero differ from AlphaGo?
...
#### Q. What is the name of a famous algorithm to minimize a function/error in a neural network?
...
#### Q. What is Artificial Super Intelligence?
