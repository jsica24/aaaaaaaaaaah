...
#### Q. The integrity threat can be examplified by which of the following scenarios:
...
#### Q. Let's talk about adversary types: we can say that Hacktivists are?:
...
#### Q. The art and science of breaking code is called:
...
#### Q. The art and science of creating code is called:
...
#### Q. Distribution, amplification, spoofing and reflection are fundamental notions of what ?:
...
#### Q. Let's talk about adversary types: we can say that vandals are?:
...
#### Q. In the words of Ritchie and Thompson, what is a Shell ?:
...
#### Q. Embedding a trap door into a login program results in which of the following:
...
#### Q. What's the equivalent of the Nobel Prize of computing:
...
#### Q. Brute force attacks are good for which of the following scenarios ?:
...
#### Q. What would be the best way to pick up a Trojan Horse trap door:
...
#### Q. Which of the following are vulnerability types?:
...
#### Q. Encryption hard wired between, for example, 2 buildings is called?:
...
#### Q. In the words of Ritchie and Thompson, what is a Kernel ?:
...
#### Q. Confidentiality issues can be solved by?:
...
#### Q. The couple "Active entity/Asset" is seen through the Reference Monitor as ?:
...
#### Q. A typical integrity threat may concern:
...
#### Q. Heuristic attacks can be countered with:
...
#### Q. A typical availability threat is ?:
...
#### Q. A malicious worm program is characterized by the following fundamental attribute:
...
#### Q. Pre-attack indicators are like post-attack indicators in which of the following ways:
...
#### Q. Where were Thompson and Ritchie working when they created UNIX:
...
#### Q. Brute force attacks can be countered with:
...
#### Q. Who is famous for insisting on the fact that proving the existence of one problem does not demonstrate the absence of others:
...
#### Q. Let's talk about adversary types: we can say that Nation-state actors are ?:
...
#### Q. What is the CIA model of cyber security ?:
...
#### Q. Cyber adversary motivations include which of the following:
...
#### Q. In what kind of threat do we use behavioral analysis ?:
...
#### Q. Let's talk about adversary types: we can say that Criminals are?:
...
#### Q. What does Thompson think about breaking into a computer system?:
...
#### Q. What could be the best way to recude the risk of finding a Trojan Horse in a compiler?:
...
#### Q. In general, integrity threats involve?:
...
#### Q. The difference between a hurricane knocking out a data center and a malicious hacker knocking out the same data center is following:
...
#### Q. Which of the following is an advantage of more reactive cyber defense (versus proactive defense)?:
...
#### Q. Who said "You can't trust code that you dit not totally create yourself" ?:
